...
[![Build Status](https://travis-ci.org/EnzoDuh/js-training.svg?branch=master)](https://travis-ci.org/EnzoDuh/js-training)
## Setup
...
git clone https://github.com/EnzoDuh/js-training.git
